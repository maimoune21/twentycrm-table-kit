/**
 * Local FilterDropdown — editable copy of upstream FilterDropdown.
 * The 14 filter sub-panels are still imported from upstream
 * (`@/components/twenty-table/toolbar/components/*FilterPanel`) so
 * they keep working. Localize them on demand if you need to edit them.
 */
...
import { CompanyFilterPanel } from "@/components/twenty-table/toolbar/components/CompanyFilterPanel";
import { FullNameFilterPanel } from "@/components/twenty-table/toolbar/components/FullNameFilterPanel";
import { EmailFilterPanel } from "@/components/twenty-table/toolbar/components/EmailFilterPanel";
import { FonctionFilterPanel } from "@/components/twenty-table/toolbar/components/FonctionFilterPanel";
import { VilleFilterPanel } from "@/components/twenty-table/toolbar/components/VilleFilterPanel";
import { EcoleFilterPanel } from "@/components/twenty-table/toolbar/components/EcoleFilterPanel";
import { CvFilterPanel } from "@/components/twenty-table/toolbar/components/CvFilterPanel";
import { GsmFilterPanel } from "@/components/twenty-table/toolbar/components/GsmFilterPanel";
import { MetierFilterPanel } from "@/components/twenty-table/toolbar/components/MetierFilterPanel";
import { TypeStageFilterPanel } from "@/components/twenty-table/toolbar/components/TypeStageFilterPanel";
import { MultiOptionCheckboxFilterPanel } from "@/components/twenty-table/toolbar/components/MultiOptionCheckboxFilterPanel";
import {
  Select,
  SelectContent,
  SelectItem,
