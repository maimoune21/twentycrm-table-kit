...
import { rowHeightSizeAtom } from "@/components/twenty-table/states";
import type { RecordTableRowHeightSize } from "@/components/twenty-table/constants";
...
export const OptionsDropdown = ({ columns }: OptionsDropdownProps) => {
  ...
  return (
    ...
    >
      {contentView === "main" ? (
        <>
          <div className="flex flex-col gap-0.5 pb-1 px-0.5">
            <DropdownMenuItem
          ...
          <DropdownSeparator />
          <div className="flex flex-col gap-0.5 py-1 px-0.5">
            <div className="px-2 py-1 text-[9.5px] font-medium text-gray-400 dark:text-gray-500 uppercase tracking-wider">
              Row Height
            </div>
        ...
        <>
          <div className="flex items-center gap-2 px-2 pt-2 border-b border-white/10 dark:border-white/10">
            <button
            ...
            {visibleColumns.map((col) => {
              return (
                <div
                  ...
                  className={`group flex items-center h-7 px-2 py-0 text-[11px] text-gray-700 dark:text-gray-100 bg-transparent hover:bg-white/10 dark:hover:bg-white/8 rounded-sm transition-colors gap-1 cursor-move ${
          ...
          <div className="border-t border-white/10 dark:border-white/10 py-1 px-0.5">
            <button
              ...
              className="flex items-center h-8 px-2 cursor-pointer py-0 text-[11px] text-gray-700 dark:text-gray-100 bg-transparent hover:bg-white/10 dark:hover:bg-white/8 rounded-sm transition-colors gap-2 w-full"
            >
              <span className="flex items-center justify-center w-4 h-4 text-gray-500 dark:text-gray-300 shrink-0">
                <IconEyeOff />
              </span>
          ...
          <div className="max-h-[calc(100vh-140px)] overflow-y-auto py-1 px-0.5 flex flex-col gap-0.5">
            {columns
              ...
              .map((col) => (
                <div
                  key={col.id}
                  className="flex items-center h-8 px-2 py-0 text-[11px] text-gray-700 dark:text-gray-100 bg-transparent hover:bg-white/10 dark:hover:bg-white/8 rounded-sm transition-colors gap-1"
                >
                  <span className="flex items-center justify-center w-4 h-4 text-gray-500 dark:text-gray-300 shrink-0">
                    {getColumnLabelIcon(col.label)}
                  </span>
