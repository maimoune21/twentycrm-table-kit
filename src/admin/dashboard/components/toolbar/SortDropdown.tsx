...
import type { ColumnDefinition, SortDirection } from "@/components/twenty-table";
...
export const SortDropdown = ({ columns }: SortDropdownProps) => {
  ...
  return (
    ...
    >
      ...
      {/* Direction selector */}
      <div className="flex items-center justify-center gap-1 px-2 py-1.5 border-b border-white/10 dark:border-white/10">
        <button
          onClick={() => setDirection("asc")}
          className={`flex items-center gap-1 px-2 py-0.5 rounded text-[10px] cursor-pointer transition-colors w-full ${
            direction === "asc"
              ? "bg-gray-300/20 border border-gray-200/60 dark:bg-gray-500/20 text-gray-600 dark:text-gray-400"
