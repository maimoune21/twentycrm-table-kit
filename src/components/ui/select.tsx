...
const selectTriggerVariants = cva(
  `
    flex bg-background w-full py-6! rounded-xl! text-base! items-center justify-between outline-none border border-input shadow-xs shadow-black/5 transition-shadow 
