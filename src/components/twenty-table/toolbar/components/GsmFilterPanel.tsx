...
export const GsmFilterPanel = ({ column, onBack }: GsmFilterPanelProps) => {
  ...
  const isTextOperator = operator === "contains" || operator === "equals";
  const canApply =
    operator === "isEmpty" ||
    operator === "isNotEmpty" ||
