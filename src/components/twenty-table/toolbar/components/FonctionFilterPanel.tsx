...
interface FonctionFilterPanelProps {
...
export const FonctionFilterPanel = ({
  column,
  onBack,
}: FonctionFilterPanelProps) => {
  ...
  const isTextOperator = operator === "contains" || operator === "doesNotContain";
  const canApply =
    operator === "isEmpty" ||
    operator === "isNotEmpty" ||
